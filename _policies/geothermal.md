...
hazard_type:
  - "grid instability"
  - "aging fossil infrastructure"
  - "energy supply concentration"
  - "industrial workforce displacement"
policy_category: "energy infrastructure"
implementation_level: "state/provincial/national"
related_policies:
...
**Approach:**
Texas applies oilfield drilling, fracturing, and subsurface modeling to geothermal energy storage and generation.
...
**Use Case:**
Replacing or supplementing aging coal plants while supporting rapid load growth from data centers.

### 2. Utah & Nevada, USA: Enhanced Geothermal Systems (EGS)
**Approach:**
Enhanced geothermal projects use deep drilling and reservoir stimulation to create artificial geothermal systems.
...
**Use Case:**
Grid-scale electricity in regions with accessible high-temperature rock.

### 3. Germany: Closed-Loop Geothermal & District Heat
**Approach:**
Germany deploys closed-loop geothermal systems using directional drilling techniques developed in oil and gas.
...
**Use Case:**
Replacing fossil-based heating in urban and industrial zones.

### 4. Netherlands: Geothermal Heat as Industrial Infrastructure
**Approach:**
Geothermal systems supply constant heat to greenhouses and are expanding toward urban heat networks.
...
**Use Case:**
Decarbonizing heat-intensive sectors without electrification bottlenecks.

### 5. United Kingdom: Deep Geothermal Pilot Scaling
**Approach:**
The UK uses government-backed pilots to test deep geothermal electricity and heat production.
...
**Use Case:**
Demonstration projects to unlock private investment.

### 6. Canada (Alberta): Repurposing Oil and Gas Wells
**Approach:**
Existing and abandoned oil and gas wells are evaluated for geothermal reuse.
...
**Use Case:**
Managing legacy oil infrastructure while extending economic value.
...
* **International Energy Agency:** Geothermal Energy Overview  
  https://www.iea.org