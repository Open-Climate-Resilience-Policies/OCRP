...
**The Policy:**
Melbourne built this idea into their official long-term plan, *[Plan Melbourne 2017–2050](https://www.planning.vic.gov.au/guides-and-resources/strategies-and-initiatives/plan-melbourne)*. They chose "20 minutes" because their suburbs are more spread out, which is a realistic goal for many North American cities too.

**How it Works (The "Hallmarks" Test):**
A neighborhood isn't just "zoned" for shops; it has to pass a test to count as a 20-minute neighborhood. It must be:
...
**The Policy:**
Portland’s *[Climate Action Plan](https://www.portland.gov/bps/climate-action/history-and-reports)* set a goal: 90% of residents should live in "complete neighborhoods."

**How it Works (The "Urban Center" Focus):**
Portland didn't change the whole city at once. They picked specific "Centers" and main streets to build up.
* **Focus on Affordability:** They use [Inclusionary Zoning](https://www.portland.gov/phb/inclusionary-housing), which means if developers want to build big apartments, they *must* include affordable units. This ensures the 15-minute lifestyle isn't just for the wealthy.

### 3. Barcelona, Spain: "Superblocks" (Superilles)
**The Policy:**
This is about changing *streets*, not just buildings.



**How it Works (Street Reallocation):**
The city takes a grid of nine blocks (3x3) and closes the inside streets to through-traffic. Cars must drive around the outside.
...
**Takeaway:** You don't always need new buildings. You can create a "15-minute city" feel just by changing how streets are used. (Read more on the [Superblocks Model](https://www.barcelona.cat/pla-superilla-barcelona/en)).

## Model Policy Language

*The following language is adapted from the [SmartCode](https://smartcodecentral.com/) framework. It is ready to be pasted into a city's Comprehensive Plan.*

### A. General Plan (Vision Statement)

**Goal: The 15-Minute Neighborhood Framework**
"The City aims to create 'Complete Neighborhoods' where residents can access daily needs—including grocery, pharmacy, elementary education, and public recreation—within a 15-minute walk or bike ride."

**Policy 1.1:**
"The City will prioritize 'Mixed-Use' (blending homes and shops) over 'Single-Use' (homes only) in all future land use decisions."

**Policy 1.2:**
"The City will focus spending on sidewalks and bike lanes within a 1-mile radius of identified Neighborhood Centers."
...
**Permitted Uses:**
The following small businesses are allowed in Residential Zones provided they are under 1,500 square feet:
...
**Exemptions:**
You do *not* need to build off-street parking for:
* Shops under 2,500 square feet if they are near a bus/train stop.
* Small residential projects (4 units or fewer).

**Shared Parking:**
New buildings can build 40% less parking if they share a lot with a neighbor (e.g., an office shares spaces with a restaurant that is only open at night).

#### 3. "Live-Work" Units
*Purpose: To help people work from home effectively.*

**Definition:**
"A building that combines a living space with a work space, used by the person living there."

**The Rule:**
Professional services (like accountants) and small makers (like potters or artists) are allowed by right, as long as they don't create dangerous noise or fumes.
...
- [ ] **Calculate the Savings:** Work with the finance department to calculate the tax revenue per acre of mixed-use vs. single-use zones (see [Urban3](https://www.urbanthree.com/) for examples).
...
- [ ] **Adopt Missing Middle Housing:** Legalize duplexes, triplexes, and [ADUs](https://www.planning.org/knowledgebase/accessorydwellings/) (backyard cottages) in single-family zones.
...
## Official Sources
* **C40 Cities:** [15-Minute City Agenda](https://www.c40.org/what-we-do/scaling-up-climate-action/15-minute-city/)
* **Strong Towns:** [A Guide to the 15-Minute City](https://www.strongtowns.org/journal/2021/4/26/what-is-a-15-minute-city)
* **Congress for the New Urbanism:** [The 15-Minute City defined](https://www.cnu.org/publicsquare/2021/02/08/defining-15-minute-city)